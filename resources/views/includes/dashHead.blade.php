...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/dashboard">Pharma</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseMedicines" aria-labelledby="headingMedicines" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Medicines Store</a>
                                    <a class="nav-link" href="/medicines">Medicines Table</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePrescriptions" aria-labelledby="headingPrescriptions" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/prescriptions">Requests</a>
                                    <a class="nav-link" href="#">Served Prescriptions</a>
                                </nav>
                            </div>
